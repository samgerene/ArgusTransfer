...
1. Configure the upstream repo (`git remote add upstream git://github.com/samgerene/ArgusTransfer`) 
...
While you're working away in your branch it's quite possible that your upstream development (most likely the canonical ArgusTransfer version) may be updated. If this happens you should:
...
And remember; **A pull-request with tests is a pull-request that's likely to be pulled in.** :grin: Bonus points if you document your feature in our [wiki](https://github.com/samgerene/ArgusTransfer/wiki) once it has been pulled in

## Style Guidelines

- Indent with 4 spaces, **not** tabs.
- No underscore (`_`) prefix for member names.
- Use `this` when accessing instance members, e.g. `this.Name = "ArgusTransfer";`.
